...
gcloud functions deploy register --entry-point register --runtime python37 --trigger-http --source=./functions/python --region=europe-west1 --update-enw-vars PROJECT_ID=${PROJECT},JWT_KEY=${JWT_KEY}
